;;; meltbus-theme.el --- Adaptation to eltbus-theme, an experimental theme that puts subtle back into emacs

;; Copyright (C) -2017 the eltbus-theme authors and Michael Raitza
...
(deftheme meltbus "Dark subtle theme based on eltbus")
...
(let* ((class '((class color) (min-colors 89)))
       ...
       (default-color `(:foreground ,text-white))
       (default-font `(:font ,font-base :height 80))
       (default-background `(:background ,black))
       (default-bgc black)
       (brighter `(:foreground ,brighter-text))
       (lessbright `(:foreground ,dull-white))
       (standout-dull `(:background ,bright-black :foreground ,dull-white))
       (standout-bright `(:background ,bright-black :foreground ,white))
  ...
  (custom-theme-set-faces
   'meltbus
   ;; Comments denote things that are missing

   `(default ((,class (,@default-color ,@default-background ,@fmt-none ,@default-font))
              (t (,@default-color ,@default-background ,@fmt-none ,@default-font))))
   ...
   `(lazy-highlight ((,class (:background ,bluish :foreground ,default-bgc))))
   ...
   ;; font-lock-exit-face
   `(font-lock-function-name-face ((,class (,@brighter ,@fmt-bld))))
   ...
   `(magit-log-author ((,class (,@fmt-none :foreground ,text-white))))
   ...
   `(org-level-1 ((,class (:height 1.5 :background ,bright-black :foreground ,white ,@fmt-bld))))
   `(org-level-2 ((,class (:height 1.4 :background ,bright-black ,@fmt-bld))))
   `(org-level-3 ((,class (:height 1.3 :background ,bright-black ,@fmt-bld))))
   `(org-level-4 ((,class (:height 1.2 :background ,bright-black ,@fmt-bld))))
   `(org-level-5 ((,class (:height 1.1 :background ,bright-black ,@fmt-bld))))
   `(org-level-6 ((,class (:height 1.0 :background ,bright-black ,@fmt-bld))))
   `(org-level-7 ((,class (:height 1.0 :background ,bright-black ,@fmt-none))))
   `(org-level-8 ((,class (:height 1.0 :background ,bright-black :foreground ,dull-white ,@fmt-none))))
...
;;; powerline
   ...
   `(spacemacs-motion-face ((,class (:foreground ,black :background "plum3" :inherit nil))))
   `(spacemacs-normal-face ((,class (:foreground ,black :background "DarkGoldenrod2" :inherit nil))))
   `(spacemacs-replace-face ((,class (:foreground ,black :background "chocolate" :inherit nil))))
   `(spacemacs-visual-face ((,class (:foreground ,black :background "gray" :inherit nil))))
...
(provide-theme 'meltbus)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; meltbus-theme.el ends here
